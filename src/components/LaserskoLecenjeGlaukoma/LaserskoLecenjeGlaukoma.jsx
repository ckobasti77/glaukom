  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-center flex-wrap gap-8 xl:gap-16 text-xl text-fourth my-12">
        {
          cards.map(card => (
            <div key={card.id} className="md-div w-[90%] xl:w-[45%] p-4 md:p-12 xl:p-16" data-aos="zoom-in-down" data-aos-delay={card.id * 200}>
                <h2 className="text-center text-gradient mb-4" data-aos="fade-up" data-aos-delay={card.id * 300}>{card.title}</h2>
                <p data-aos="fade-up" data-aos-delay={card.id * 400}>{card.text}</p>
            </div>
          ))
        }
      </div>
